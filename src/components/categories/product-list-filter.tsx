...
export const ProductListFilter = () => {
  ...
  //linha 24, mostrar o s apenas se houver mais de um produto
  return (
    <>
      <div className="flex flex-col md:flex-row gap-6 justify-between items-start md:items-center">
        ...
        <div className="w-full md:max-w-70 flex flex-row gap-5">
          <select
            ...
            className="h-14 flex-1 flex items-center justify-center px-6 bg-white border border-gray-200 rounded-sm text-gray-500"
          >
          ...
          <div
            ...
            className="h-14 flex-1 flex md:hidden items-center justify-center  px-6 bg-white border border-gray-200 rounded-sm text-gray-500"
          >
            Filtrar por
          </div>
        </div>
      ...
      <div className="mt-8 flex flex-col md:flex-row gap-8">
        ...
        >
          ...
          <FilterGroup id="front" name="front-end" />
        </div>
